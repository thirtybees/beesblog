...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_category`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_category` (
...
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_category_lang`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_category_lang` (
  `id_bees_blog_category`   INT(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `_DB_PREFIX_bees_blog_category_lang` (`id_bees_blog_category`, `id_lang`, `title`, `description`, `link_rewrite`) VALUES
(5, 1, 'Social Acquisition', 'Social acquisition from beginner to hero', 'social-acquisition');
INSERT INTO `_DB_PREFIX_bees_blog_category` (`id_bees_blog_category`, `id_parent`, `position`, `active`, `date_add`, `date_upd`) VALUES
...
-- MAJ Table `mydb`.`blog_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_post`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_post` (
...
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_post_lang`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_post_lang` (
  `id_bees_blog_post`  INT(10) NOT NULL AUTO_INCREMENT,
  `id_lang`            INT(10) NOT NULL,
...
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_post_shop`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_post_shop` (
  `id_bees_blog_post`  INT(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `_DB_PREFIX_bees_blog_post` (`id_bees_blog_post`, `active`, `comments_enabled`, `date_add`, `date_upd`, `published`, `id_category`, `id_employee`, `image`, `position`, `post_type`, `viewed`) VALUES
...
INSERT INTO `_DB_PREFIX_bees_blog_post_shop` (`id_bees_blog_post`, `id_shop`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 1);

INSERT INTO `_DB_PREFIX_bees_blog_post_lang` (`id_bees_blog_post`, `id_lang`, `title`, `content`, `link_rewrite`, `lang_active`) VALUES
...
-- -----------------------------------------------------
-- MAJ Table `mydb`.`_DB_PREFIX_bees_blog_image_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_image_type`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_image_type` (
...
ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
INSERT INTO `_DB_PREFIX_bees_blog_image_type` (`id_bees_blog_image_type`, `name`, `width`, `height`, `posts`, `categories`) VALUES (NULL, 'aaa', '650', '200', '1', '0');

DROP TABLE IF EXISTS `_DB_PREFIX_bees_blog_image_type_shop`;
CREATE TABLE IF NOT EXISTS `_DB_PREFIX_bees_blog_image_type_shop` (
  `id_bees_blog_image_type`  INT(10) NOT NULL AUTO_INCREMENT,
  `id_shop`                  INT(10) NOT NULL,
  PRIMARY KEY (`id_bees_blog_image_type`))
ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `_DB_PREFIX_bees_blog_image_type` (`id_bees_blog_image_type`, `name`, `width`, `height`, `posts`, `categories`) VALUES
(1, 'column', 260, 163, 1, 1),
(2, 'post_list_item', 400, 250, 1, 0),
(3, 'post_default', 800, 500, 1, 0),
(4, 'category_default', 800, 500, 0, 1);
INSERT INTO `_DB_PREFIX_bees_blog_image_type_shop` (`id_bees_blog_image_type`, `id_shop`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 1);
